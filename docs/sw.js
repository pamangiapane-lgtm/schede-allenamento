// Service Worker App Marsala Volley (marsala-schede-v340-w5-s3-rdl-3x4)
const CACHE_NAME = 'marsala-schede-v340-w5-s3-rdl-3x4';

const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './data.js?v=20260923v340-w5-s3-rdl-3x4',
