// Service Worker App Marsala Volley (marsala-schede-v341-w5-s3-push-press)
const CACHE_NAME = 'marsala-schede-v341-w5-s3-push-press';

const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './data.js?v=20260923v341-w5-s3-push-press',
