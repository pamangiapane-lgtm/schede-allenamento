// Service Worker App Marsala Volley (marsala-schede-v345-w5-s3-hang-bw)
const CACHE_NAME = 'marsala-schede-v345-w5-s3-hang-bw';

const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './data.js?v=20260923v345-w5-s3-hang-bw',
