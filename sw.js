// Service Worker App Marsala Volley (marsala-schede-v343-w5-s3-deadbug-rdl-range)
const CACHE_NAME = 'marsala-schede-v343-w5-s3-deadbug-rdl-range';

const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './data.js?v=20260923v343-w5-s3-deadbug-rdl-range',
