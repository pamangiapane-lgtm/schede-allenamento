// Service Worker App Marsala Volley (marsala-schede-v344-w5-s3-rdl-rpe8)
const CACHE_NAME = 'marsala-schede-v344-w5-s3-rdl-rpe8';

const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './data.js?v=20260923v344-w5-s3-rdl-rpe8',
