# Scheda Sedute Campo — Settimana 1 (FINALE)
**Fonte**: Preseason_A2_2026_Programma_FINALE.md (versione convergente v2+v3 — operativa raccomandata)
...
| 3 | Prevenzione ruolo | Menù W1-2 (§ glossario) | Forza mirata sul punto debole del ruolo | — | 2-3 serie | RPE5 | 60-90" | 5 |
| 4 | Forza | Squat | Forza massima bilaterale — schiena neutra, spinta decisa | Box Squat · Front Squat volume ridotto | 4×2 | 78% | 2'30" | 7 |
...
| 6 | Atterraggi | Box jump atterraggio pulito | Salto verticale, enfasi sull'atterraggio | Atterraggio su materassino | 3×3 | — | 90" | 6 |
...
Nota: il tetto assoluto di forza in questa versione è **87%** (mai superato in tutto il ciclo). Totale reale: ~52' + buffer ~8-10' = **~58-60'**.
...
| 3 | WL (mai sospeso) | Clean | Weightlifting derivato — tripla estensione, priorità tecnica | Hang Clean | 3×2 | 70% | 2' | 6 |
| 4 | Barra veloce | Squat veloce, intento massimo | Forza-velocità a carico basso | Jump Squat a corpo libero | 4×3 | 60% | 2' | 7 |
